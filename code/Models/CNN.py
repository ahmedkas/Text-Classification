...
def Train(x, y, epochs = 100, batch_size = 128, LR = 0.001, n_layers = 3, filters = 32, dropout = False, MaxPooling = False, Embedding = False, vocab_size = None, embedding_dim = 64, loss = "binary_crossentropy"):
    ...
    for i in range(n_layers):
        model.add(keras.layers.Conv1D(filters, 3, activation='relu'))
        if dropout == True:
